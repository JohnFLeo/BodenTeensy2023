...
void testInterrupts(){
    for(int i = 0; i < 32; i++) {
        ...
        //if(!(i==3||i==8||i==11||i==13||i==14||i==16||i==18||i==23||i==25||i==28)){//für teensy mit "neuen Motorshield"3,8,11,13,14,16,18,23,25
            Serial.print(i);
            Serial.print(": ");
...
void isInterrupt(){
    ...
    for (int i = 0; i < 32; ++i) {
        if(!(i==11||i==18||i==19||i==26||i==28||i==8)){
        //if(!(i==3||i==8||i==11||i==13||i==14||i==16||i==18||i==23||i==25||i==28)){//für teensy mit "neuen Motorshield"
